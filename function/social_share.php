...
gapi_processed="true">{lang: 'it'}</script>
 ...
 <div class="g-plus" data-action="share" data-annotation="bubble" data-href="<?PHP ECHO $url;?>"></div>
<iframe allowtransparency="true" frameborder="0" scrolling="no" 
src="http://platform.twitter.com/widgets/tweet_button.1363148939.html#_=1363858552827
&amp;count=horizontal&amp;
counturl=<?PHP echo urlencode($url);?>
&amp;

related=novaproget&amp;size=m&amp;
text=<?PHP ECHO $array['nomeaziendale']?>
&amp;url=<?PHP echo urlencode($url);?>&amp;via=novaproget"
...
if(typeof(tweetmeme_alias) != "undefined") $("#share .twitter-share-button").attr("data-url", tweetmeme_alias);
	...
	<div class="fb-like" data-href="<?PHP ECHO 'http://'.$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'];?>" data-send="false" data-width="450" data-show-faces="true" data-font="segoe ui" data-action="recommend" data-layout="button_count" ></div>
		<a href=''>
<img src='<?PHP echo root_shared();?>img/facebook-icon_25x25.png' style='top:3px;;border:0;position:relative;'></a>
								<div id="fb-root"></div>
