...
<link href="<?=pathsito();?>style.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="<?=pathsito();?>ui/jcorn.js"></script> 
<script type="text/javascript" src="<?=pathsito();?>ui/jquery-ui-1.9.2.custom.min.js"></script> 
...
$(function() {
	...
	$('#sottomenu li ul').css({display: "none",left: "auto"});
		$('#sottomenu li').hover(function() {$(this).find('ul').stop(true, true).slideDown('fast');},
